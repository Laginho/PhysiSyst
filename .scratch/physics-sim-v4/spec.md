...
- **A mola usa a junta de mola do Rapier** (`rest_length = x₀`, `stiffness = k`, `damping = c`). `F_el` é calculada por nós (`k·Δx` mais o termo de `c`), porque o Rapier não a devolve.
