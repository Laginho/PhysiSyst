...
4. Teste novo: cadeia com `c = 0,5` e `mₛ = 0,1`, envelope de picos dentro de 2% da mola ideal com o mesmo `c` em 10 picos; vermelho ao zerar o termo de `c` em `chainTensions`
5. Gate verde
